      ...
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          ...
          <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
            <Text style={styles.lastUpdated}>Effective Date: August 2026 • VASTRA</Text>

            <Text style={styles.sectionHeading}>1. Acceptance of Terms</Text>
            <Text style={styles.bodyText}>
              By registering or using the VASTRA mobile application, you agree to these Terms and Conditions. This app is provided exclusively for registered hostel students and authorized laundry staff of RVS University.
            </Text>
