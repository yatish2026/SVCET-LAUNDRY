...
export const PhotoUploader = ({
  ...
  const takePhotoWithCamera = async () => {
    try {
        ...
        try {
          ...
          if (status !== 'granted') {
            Alert.alert(
              ...
              'Please allow Camera permission for VASTRA in Phone Settings -> Apps -> VASTRA -> Permissions to take clothes photos.'
            );
            return;
          }
        } catch (permErr) {
      ...
      Alert.alert(
        'Camera Permission',
        'Please allow Camera permission for VASTRA in Phone Settings -> Apps -> VASTRA -> Permissions.'
      );
    }
  };
